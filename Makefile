...
install: all
	...
	$(INSTALL) -o root -g root -m 644 man/shield-trigger.8 ${mandir}
	$(INSTALL) -o root -g root -m 644 man/shield-trigger-iptables.8 ${mandir}
	$(INSTALL) -o root -g root -m 644 man/shield-purge.8 ${mandir}
...
uninstall:
	...
	$(RM) ${mandir}/shield-trigger.8
	$(RM) ${mandir}/shield-trigger-iptables.8
	$(RM) ${mandir}/shield-purge.8
